    ...
    <>
      ...
      <article className="my-2 mx-auto py-3 px-5 w-100">
        ...
        <section className="px-3">
          ...
          <p>To submit a new request, sign into your employee account and choose <mark>New Reimbursement Request</mark> on the dashboard. Requests should be separated into the following 4 categories:
          </p>
          ...
          <dl className="row w-75 mx-auto">
            ...
            <dd className="col-sm-9">not including room service, which is covered under the hotel bill</dd>
            <dt className="col-sm-2">Other</dt>
            <dd className="col-sm-9">i.e. conference registration fees, office supplies, or parking expenses</dd>
            <small className="fst-italic"><strong>NOTE: </strong>Requests submitted with the "Other" category must include details of the expense in the comments section on submission.</small>
          </dl>

          <p>For example, submitting requests for a work assignment requiring a hotel and rental car should have one request under <strong>Lodging</strong>, and the other under <strong>Travel</strong>.
          </p>
        ...
        <section className="px-3">
          ...
          <p>While on assignment, receipts for any expenses incurred should be submitted to your supervisor in your post-assignment packet. Submitted requests will be approved or denied by your department supervisor, or by HR directly. You can view both pending and completed requests from the Dashboard.
          </p>
        ...
        <section className="px-3">
          ...
          <p>You can submit another request right away, but <strong>be sure to include the erroneous request ID</strong> in the comments section of the new request.
          </p>
        </section>
      </article>
    </>
